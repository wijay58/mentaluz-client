...
import { AppBar, Box, Container, CssBaseline, Toolbar, Typography, useMediaQuery, Grid } from '@mui/material';
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Main theme={theme} open={drawerOpen} layout={layout}>
        ...
        <div style={{ display: 'flex', justifyContent: 'end', marginTop: '1rem' }} className='footer'>
          <Grid item>
            <Typography color='gray' style={{ marginRight: '8px', cursor: 'pointer', textDecoration: 'underline' }} variant="h6">Contact Us</Typography>
          </Grid>
          <Grid item>
            <Typography color='gray' style={{ marginRight: '8px', cursor: 'pointer', textDecoration: 'underline' }} variant="h6">Terms & Conditions</Typography>
          </Grid>
          <Grid item>
            <Typography color='gray' style={{ marginRight: '8px', cursor: 'pointer', textDecoration: 'underline' }} variant="h6">Privacy Policy</Typography>
          </Grid>
        </div>
      </Main>
      <Customization />
